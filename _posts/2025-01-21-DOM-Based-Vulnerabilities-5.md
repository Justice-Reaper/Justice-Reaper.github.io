---
title: DOM Based Vulnerabilities 5
...
image:
  path: /assets/img/DOM-Based-Vulnerabilities-5/Portswigger.png
---
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_1.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_5.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_6.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_7.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_8.png)

Si `insertamos` este payload `'><script>alert(3)</script>` al `recargar` la `web` nos `muestra` un `alert`

![](/assets/img/DOM-Based-Vulnerabilities-5/image_9.png)

![](/assets/img/DOM-Based-Vulnerabilities-5/image_10.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_11.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-5/image_12.png)
