...
![[AUTENTICATION LAB 12/Authentication-Lab-12/image_1.png]]

Pulsamos sobre `My account`, nos `logueamos` usando las credenciales `wiener:peter`

![[AUTENTICATION LAB 12/Authentication-Lab-12/image_2.png]]

Podemos `cambiar` nuestra `contraseña`

![[AUTENTICATION LAB 12/Authentication-Lab-12/image_3.png]]

Si `capturamos` la `petición` de `cambio` de `contraseña` vemos lo siguiente

![[AUTENTICATION LAB 12/Authentication-Lab-12/image_4.png]]
...
![[AUTENTICATION LAB 12/Authentication-Lab-12/image_5.png]]
...
![[AUTENTICATION LAB 12/Authentication-Lab-12/image_6.png]]

`Capturamos` la `petición` y la `mandamos` al `Intruder`

![[AUTENTICATION LAB 12/Authentication-Lab-12/image_7.png]]
...
![[AUTENTICATION LAB 12/Authentication-Lab-12/image_8.png]]
...
![[AUTENTICATION LAB 12/Authentication-Lab-12/image_9.png]]

Nos `logueamos` con las credenciales `carlos:michael`

![[AUTENTICATION LAB 12/Authentication-Lab-12/image_10.png]]
