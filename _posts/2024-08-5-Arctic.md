...
![[Pasted image 20240805184801.png]]
...
`Ejecutamos` el `JuicyPotato`, los `CLIDS` los podemos mirar en esta `web` [http://ohpe.it/juicy-potato/CLSID/Windows_Server_2008_R2_Enterprise/](http://ohpe.it/juicy-potato/CLSID/Windows_Server_2008_R2_Enterprise/)
