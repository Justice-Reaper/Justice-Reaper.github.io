...
![](/assets/img/Authentication-Lab-4/image_13.png)
...
![](/assets/img/Authentication-Lab-4/image_14.png)
...
![](/assets/img/Authentication-Lab-4/image_15.png)
...
![](/assets/img/Authentication-Lab-4/image_16.png)

Desde el `Intruder` seleccionamos los `payloads`

![](/assets/img/Authentication-Lab-4/image_17.png)

`Configuramos` el `primer payload`

![](/assets/img/Authentication-Lab-4/image_18.png)
...
![](/assets/img/Authentication-Lab-4/image_19.png)
...
![](/assets/img/Authentication-Lab-4/image_20.png)

Nos `logueamos` con las `credenciales analyzer:jordan`

![](/assets/img/Authentication-Lab-4/image_21.png)
...
![](/assets/img/Authentication-Lab-4/image_22.png)

![](/assets/img/Authentication-Lab-4/image_23.png)
