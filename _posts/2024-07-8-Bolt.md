...
![[Pasted image 20240708124516.png]]

En el login de la web (`http://10.129.254.109/login`) visualizamos lo siguiente 

![[Pasted image 20240708124805.png]]

Si nos fijamos en el title de la venta, pone lo siguiente, si está usando `jinja` puede ser vulnerable alguna parte de la web a `SSTI` (Server Side Template Inyection)

![[Pasted image 20240708124838.png]]

Por ahora vamos a pulsar en `Create account` y vamos a crearnos una cuenta en `http://10.129.254.109/register`

![[Pasted image 20240708124943.png]]

Al intentar `registrarnos` nos lanza este `error`

![[Pasted image 20240708125142.png]]
...
![[Pasted image 20240708125532.png]]
...
![[Pasted image 20240708130430.png]]

Este botón nos devuelve a la página principal y no se envía nada tampoco

![[Pasted image 20240708125702.png]]

Al intentar loguearnos con usuarios y password aleatorios nos dice que forbidden, lo cual es raro

![[Pasted image 20240708125855.png]]

Al acceder al dominio passbolt.bolt.htb nos encontramos lo siguiente

![[Pasted image 20240708130204.png]]

Cuando pulsamos en `Next` obtenemos la siguiente respuesta

![[Pasted image 20240708130227.png]]
...
![[Pasted image 20240708130537.png]]
...
![[Pasted image 20240708153457.png]]
...
![[Pasted image 20240708153526.png]]
...
Ahora al intentar loguearnos en `demo.bolt.htb` si que nos deja

![[Pasted image 20240708164746.png]]

A continuación nos redirige a la página de `iniciar sesión`

![[Pasted image 20240708164712.png]]
...
![[Pasted image 20240708164906.png]]
## Web Exploitation
...
![[Pasted image 20240708170222.png]]
...
![[Pasted image 20240708171606.png]]
...
![[Pasted image 20240708171926.png]]
## Intrusión
...
![[Pasted image 20240708173004.png]]
...
![[Pasted image 20240709145941.png]]
...
![[Pasted image 20240709150104.png]]
