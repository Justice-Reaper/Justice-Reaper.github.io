...
`Blue` es una máquina `easy windows`, ganamos acceso a la máquina víctima explotando el `Eternal Blue (MS17-010)` y posteriormente establecemos `persistencia` mediante `eventos Wmi`
