---
title: DOM Based Vulnerabilities 2
...
image:
  path: /assets/img/DOM-Based-Vulnerabilities-2/Portswigger.png
---
...
![](/assets/img/DOM-Based-Vulnerabilities-2/image_1.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-2/image_2.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-2/image_3.png)

Si se `cumplen` estas `condiciones`, el `script` nos hace un `redirect` a la `url introducida`

![](/assets/img/DOM-Based-Vulnerabilities-2/image_4.png)

Podemos aprovechar el `redirect` para `inyectar código JavaScript`

![](/assets/img/DOM-Based-Vulnerabilities-2/image_5.png)

![](/assets/img/DOM-Based-Vulnerabilities-2/image_6.png)
...
![](/assets/img/DOM-Based-Vulnerabilities-2/image_7.png)
