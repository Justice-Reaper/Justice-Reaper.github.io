...
```
PPF_WRAPPER_NAME="searchLogger_js_file" npx pp-finder compile --agent browser searchLogger.js -o searchLogger_compiled.js
```

```
PPF_WRAPPER_NAME="labHeader_js_file" npx pp-finder compile --agent browser labHeader.js -o labHeader_compiled.js
```

```
PPF_WRAPPER_NAME="deparam_js_file" npx pp-finder compile --agent browser deparam.js -o deparam_compiled.js 
```
...
![[Prototype-Pollution-Lab-2/image_7.png]]
...
```
<script>Pegar el contenido de labHeader_compiled.js aquí dentro</script>
```

![[image_10.png]]

Una vez hecho esto, `tunelizamos el tráfico del navegador a través del proxy para que nos aplique las sustituciones, nos abrimos la consola en el navegador y vemos que en el archivo searchLogger hay posibles gadgets`
