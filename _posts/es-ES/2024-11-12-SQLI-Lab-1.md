...
Podemos usar la `cheat sheet` de `Portswigger` https://portswigger.net/web-security/sql-injection/cheat-sheet que nos ayudará a lo hora de `explotar inyecciones SQL`
