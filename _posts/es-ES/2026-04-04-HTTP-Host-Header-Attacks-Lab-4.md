...
![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_1.png)
...
![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_2.png)

![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_3.png)
...
![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_5.png)

Lo siguiente que debemos hacer es desactivar el Payload encoding y pulsar sobre Start attack

![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_6.png)
...
![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_7.png)

Si hacemos click derecho > Open response in browser vemos esto

![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_8.png)

Si realizamos esta petición y la capturamos con Burpsuite, vemos esto

![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_9.png)

![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_10.png)
...
![](/assets/img/HTTP-Host-Header-Attacks-Lab-4/image_11.png)
