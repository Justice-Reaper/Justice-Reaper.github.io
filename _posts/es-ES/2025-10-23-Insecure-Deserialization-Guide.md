...
La deserialización es el proceso de restaurar ese flujo de bytes a una réplica totalmente funcional del objeto original y en el mismo estado en que fue serializado. La lógica del sitio web puede entonces interactuar con este objeto deserializado, igual que lo haría con cualquier otro objeto
