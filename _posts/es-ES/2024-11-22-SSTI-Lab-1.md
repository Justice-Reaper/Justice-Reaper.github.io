...
`Antes` de `completar` este `laboratorio` es recomendable `leerse` esta `guía de SSTI` [https://justice-reaper.github.io/posts/SSTI-Guide/](https://justice-reaper.github.io/posts/SSTI-Guide/)
