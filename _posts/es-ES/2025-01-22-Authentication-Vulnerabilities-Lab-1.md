...
![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_1.png)
...
![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_5.png)

Una vez hecho esto, `iniciamos` el `ataque` de `fuerza bruta` y `filtramos` por `Length`

![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_6.png)
...
![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_7.png)

Para `bruteforcear` la `contraseña` debemos `marcar` el `campo password` en el `Intruder`

![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_8.png)
...
![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_9.png)

A continuación debemos `iniciar` el `ataque` de `fuerza bruta` y `filtrar` por `Length`

![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_10.png)

Una vez tenemos las credenciales `as400:monitor` nos podemos `loguear` usándolas en el `panel` de `login`

![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_11.png)

![](/assets/img/Authentication-Vulnerabilities-Lab-1/image_12.png)
